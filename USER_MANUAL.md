...
- **Blank Screen?** Try resizing the window or clicking "Force Auto-Rescale".
- **Installer Issues?** Ensure you have permissions to write to the installation directory.

### License

This software is provided "AS-IS" under the GNU GPLv3 License.
